...
public class Lavagon extends ShootingEnemy
{
	 ...
	 */
	public Lavagon(Framework framework, Vector2 position, Shot shot, ShotDecorator shotDec)
	{
	 ...
	 */
	public Lavagon(Framework framework, Vector2 position, Shot shot, ShotDecorator shotDec, int maxShots)
	{
	 ...
	 */
	public Lavagon(Framework framework, Vector2 position, Shot shot, ShotDecorator shotDec, boolean unlimited)
	{
		this(framework, position, shot, shotDec);
	...
	{
		if (entity instanceof Ship) entity.damage(1);
